...
OUTPUT_DIR = 'train_many/'
NUM_IMAGES_PER_CLASS = 2400
...
def create_random_crops(image_filename, num_crops, out_dir):
  ...
  # dim = dim.split()
  im_width = int(img.shape[0])
  im_height = int(img.shape[1])
...
for i in range(97, 97+26):
  char_list.append(chr(i))
char_list.append(chr(92)+chr(35))
char_list.append(chr(36))
char_list.append(chr(37))
char_list.append(chr(92)+chr(40))
char_list.append(chr(92)+chr(41))
char_list.append(chr(92)+chr(42))
char_list.append(chr(45))
char_list.append(chr(58))
char_list.append(chr(64))
...
all_backgrounds = [light_backgrounds]
